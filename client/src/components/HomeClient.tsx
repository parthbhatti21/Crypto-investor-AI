  ...
  if (address) {
    return (
      <div className="flex items-center justify-center gap-3 pt-2 flex-wrap">
        <Link
          href="/predictions"
          className="rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 px-7 py-3 text-sm font-bold text-white shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 transition-all hover:scale-[1.02] active:scale-[0.98]"
        >
          Go to Predictions →
        </Link>
        <Link
  ...
  return (
    <div className="flex flex-col items-center gap-3 pt-2">
      ...
      <p className="text-xs text-zinc-600">
        Need Freighter?{" "}
        <a href="https://freighter.app" target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:text-violet-300 underline">
          Download it here ↗
        </a>
      </p>
    </div>
